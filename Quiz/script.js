...
var questions = [
    new Question("Что необходимо выяснить перед началом ремонта силового трансформатора?",
        ["Все указанное в других ответах.", "В каком состоянии находится масло в трансформаторе и требуется ли его замена.",
            "Необходимую потребность в материалах, инструментах, приспособлениях для ремонта.",
            "HКакие дефекты присутствуют в трансформаторе и, следовательно, обьем ремонта."],
        "Все указанное в других ответах."),
